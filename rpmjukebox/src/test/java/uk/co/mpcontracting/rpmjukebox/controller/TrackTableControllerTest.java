...
public class TrackTableControllerTest extends AbstractTest {
    ...
    public void setup() {
        ...
        spyTrackTableView = spy((uk.co.mpcontracting.rpmjukebox.component.TrackTableView<TrackTableModel>)ReflectionTestUtils.getField(trackTableController, "trackTableView"));
        ReflectionTestUtils.setField(trackTableController, "trackTableView", spyTrackTableView);
        
        ((ObservableList<TrackTableModel>)ReflectionTestUtils.getField(trackTableController, "observableTracks")).clear();
    }
    ...
    public void shouldUpdateObservableTracks() {
        ...
        @SuppressWarnings("unchecked")
        ObservableList<TrackTableModel> observableTracks = (ObservableList<TrackTableModel>)ReflectionTestUtils.getField(trackTableController, "observableTracks");
    ...
    public void shouldUpdatePlaylistFromEvent() {
        ...
        Track track = new Track("1231", "Artist Name 1", "Artist Image 1", "4561", "Album Name 1", "Album Image 1", 2001, "7891", 
            "Track Name 1", 1, "Location 1", true, null);
    ...
    private Playlist generatePlaylist() {
        ...
        for (int i = 0; i < 10; i++) {
            playlist.addTrack(new Track("123" + i, "Artist Name " + i, "Artist Image " + i, "456" + i, "Album Name " + i, "Album Image " + i, 2000 + i, "789" + i, 
                "Track Name " + i, (i + 1), "Location " + i, true, null));
        }
