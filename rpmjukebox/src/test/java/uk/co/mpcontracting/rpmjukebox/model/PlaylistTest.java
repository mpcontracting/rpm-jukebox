...
public class PlaylistTest extends AbstractTest {
    ...
    public void shouldFailToGetPlaylistTrack() {
        ...
        Track result = playlist.getPlaylistTrack(new Track("1230", null, null, "4560", null, null, 2000, "7890", null, 1, null, false, null));
    ...
    public void shouldNotRemoveTrackWhenItDoesntExist() {
        ...
        playlist.removeTrack(new Track("1230", null, null, "4560", null, null, 2000, "7890", null, 1, null, false, null));
    ...
    public void shouldSwapTracksSourceLessThanTarget() {
        Playlist playlist = createPlaylist(1, "Playlist", 10);
        Track source = playlist.getPlaylistTrack(new Track("1232", null, null, "4562", null, null, 2000, "7892", null, 1, null, false, null));
        Track target = playlist.getPlaylistTrack(new Track("1238", null, null, "4568", null, null, 2000, "7898", null, 1, null, false, null));
    ...
    public void shouldSwapTracksTargetLessThanSource() {
        Playlist playlist = createPlaylist(1, "Playlist", 10);
        Track target = playlist.getPlaylistTrack(new Track("1232", null, null, "4562", null, null, 2000, "7892", null, 1, null, false, null));
        Track source = playlist.getPlaylistTrack(new Track("1238", null, null, "4568", null, null, 2000, "7898", null, 1, null, false, null));
    ...
    public void shouldClonePlaylist() {
        ...
        assertThat("Playlist tracks should be equal", getAreTrackListsEqual(clone.getTracks(), playlist.getTracks()), equalTo(true));
        assertThat("Playlist shuffled tracks should be equal", getAreTrackListsEqual(cloneShuffledTracks, playlistShuffledTracks), equalTo(true));
    ...
    private Playlist createPlaylist(int playlistId, String playlistName, int maxPlaylistSize) {
        ...
        for (int i = 1; i <= maxPlaylistSize; i++) {
            tracks.add(new Track("123" + i, null, null, "456" + i, null, null, 2000 + i, "789" + i, null, i, null, false, null));
        }
