...
public class LoveButtonTableCellTest extends AbstractTest implements Constants {
    ...
    public void shouldUpdateItemWhenTrackIsInFavourites() {
        ...
        assertThat("ID should be '" + STYLE_LOVE_BUTTON_ON + "'", loveButtonTableCell.getId(), equalTo(STYLE_LOVE_BUTTON_ON));
    }
    ...
    public void shouldUpdateItemWhenTrackIsNotInFavourites() {
        ...
        assertThat("ID should be '" + STYLE_LOVE_BUTTON_OFF + "'", loveButtonTableCell.getId(), equalTo(STYLE_LOVE_BUTTON_OFF));
    }
