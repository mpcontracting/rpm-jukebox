...
public class SettingsControllerTest extends AbstractTest implements Constants {
    ...
    public void shouldBindSystemSettings() throws Exception {
        ...
        TextField cacheSizeMbTextField = (TextField)ReflectionTestUtils.getField(settingsController, "cacheSizeMbTextField");
        
        assertThat("Cache size border should be '" + STYLE_VALID_BORDER + "'", cacheSizeMbTextField.getStyle(), equalTo(STYLE_VALID_BORDER));
    }
    ...
    public void shouldNotBindSystemSettingsWhenCacheSizeTooSmall() throws Exception {
        ...
        assertThat("Cache size border should be '" + STYLE_INVALID_BORDER + "'", cacheSizeMbTextField.getStyle(), equalTo(STYLE_INVALID_BORDER));
    }
    ...
    public void shouldClickReindexButtonAndThrowExceptionOnIndexData() throws Exception {
        doThrow(new RuntimeException("SettingsControllerTest.shouldClickReindexButtonAndThrowExceptionOnIndexData()")).when(mockSearchManager).indexData(anyBoolean());
