...
public class PlaylistManagerTest extends AbstractTest implements Constants {
    ...
    public void shouldPlayPlaylist() {
        ...
        assertThat("Current playlist ID should be " + PLAYLIST_ID_FAVOURITES, currentPlaylistId,
        ...
        assertThat("Playing playlist ID should be " + PLAYLIST_ID_FAVOURITES, playingPlaylist.getPlaylistId(),
            equalTo(PLAYLIST_ID_FAVOURITES));
    ...
    public void shouldPlayCurrentTrackNoShuffleNoOverride() {
        ...
        assertThat("Current track ID should be 5", currentTrack.getTrackId(),
            equalTo(Integer.toString(currentPlaylistIndex)));
    ...
    public void shouldResumeCurrentTrackWithDifferentCurrentTrack() {
        ...
        ReflectionTestUtils.setField(spyPlaylistManager, "playingPlaylist", mockPlayingPlaylist);
        ReflectionTestUtils.setField(spyPlaylistManager, "currentTrack",
